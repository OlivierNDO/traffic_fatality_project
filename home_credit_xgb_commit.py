...
# Import .csv Files
###################################################################
application_test = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/application_test.csv')
application_train = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/application_train.csv')
bureau = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/bureau.csv')
bureau_balance = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/bureau_balance.csv')
credit_card_balance = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/credit_card_balance.csv')
installments_payments = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/installments_payments.csv')
pos_cash_balance = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/pos_cash_balance.csv')
previous_application = pd.read_csv('C:/Users/user/Desktop/kaggle_data/home_credit/previous_application.csv')
